                        ...
                        <tbody>
                            @foreach($users as $user)
                                <tr>
                                    ...
                                    <td>
                                        @if($user->google_id)
                                            <span style="color: var(--success); font-size: 12px; display: inline-flex; align-items: center; gap: 4px;">
                                                🟢 เชื่อมต่อแล้ว
                                            </span>
                                        @else
                                    ...
                                    <td style="text-align: right;">
                                        <button class="btn-secondary" style="padding: 6px 12px; font-size: 12px; border-radius: 8px;" onclick="openResetModal('{{ $user->id }}', '{{ $user->name }}')">
                                            รีเซ็ตรหัสผ่าน
                                        </button>
                                    </td>
                                </tr>
            ...
            <div style="display: flex; flex-direction: column; gap: 24px;">
                ...
                <div class="glass-card">
                    ...
                    <form action="{{ route('phy70.users.invite') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" id="invite_email" name="email" class="form-control" placeholder="staff@agency.com" required>
                        </div>
                ...
                <div class="glass-card" style="background: linear-gradient(135deg, rgba(99, 102, 241, 0.05) 0%, rgba(6, 182, 212, 0.05) 100%);">
                    ...
                    <p style="font-size: 12.5px; color: var(--text-muted); line-height: 1.6; margin-bottom: 16px;">
                        ท่านสามารถเชื่อมโยงบัญชีนี้เข้ากับระบบ Google Login ของตัวท่านเอง เพื่อความปลอดภัยและการเข้าถึงที่รวดเร็วขึ้น
                    </p>
                    
                    @if(auth('phy70')->user()->google_id)
                        <div style="background: rgba(16, 185, 129, 0.1); border: 1px solid rgba(16, 185, 129, 0.2); padding: 10px 14px; border-radius: 8px; color: var(--success); font-size: 12.5px; font-weight: 500; text-align: center;">
                            ✓ บัญชีของคุณเชื่อมต่อกับ Google แล้ว
                        </div>
                    @else
                        <a href="{{ route('phy70.google.redirect') }}?link=1" class="btn-secondary" style="width: 100%; display: flex; align-items: center; justify-content: center; gap: 8px; font-size: 12.5px;">
                            <svg width="14" height="14" viewBox="0 0 24 24">
                                <path fill="currentColor" d="M23.49 12.27c0-.81-.07-1.59-.2-2.34H12v4.47h6.46c-.28 1.47-1.11 2.71-2.36 3.55l3.66 2.84c2.14-1.97 3.73-4.88 3.73-8.52z"/>
                            </svg>
        ...
        <div class="modal-box" onclick="event.stopPropagation()">
            ...
            <form id="reset-password-form" method="POST" action="">
                ...
                <div class="form-group">
                    ...
                    <input type="password" id="new_password_confirm" name="password_confirmation" class="form-control" placeholder="••••••••" required>
                </div>
