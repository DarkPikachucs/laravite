<x-phy70::layouts.master>
  ...
  <div class="manual-container">
    ...
    <div class="card">
      <h2>0. การเข้าถึงคู่มือการใช้งาน</h2>
      <p>ผู้ใช้งานสามารถเข้าถึงคู่มือการใช้งานระบบได้ โดยคลิกที่ปุ่ม "คู่มือการใช้งาน" เพื่อเปิดหน้าคู่มือ</p>
      <ul>
        <li><a href="https://drive.google.com/file/d/1IDvTJa9aVNnds8Pl9c5UTDXn_8TWLVXe/view" target="_blank"
            class="highlight">คู่มือการใช้งาน
            คลิกที่นี่</a></li>
      </ul>
    </div>
