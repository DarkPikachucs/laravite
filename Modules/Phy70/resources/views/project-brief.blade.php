      ...
      function exportToWord(elementId, filename = 'document') {
          ...
          var styles = `
              <style>
                  ...
                  body { font-family: 'Sarabun', 'Cordia New', 'TH SarabunPSK', sans-serif; font-size: 16pt; color: #000; }
                  table { width: 100%; border-collapse: collapse; margin-top: 15px; }
                  th, td { border: 1px solid #000; padding: 8px; vertical-align: top; text-align: left; font-size: 16pt; }
                  ...
                  .brief-heading { text-align: center; font-size: 18pt; font-weight: bold; margin-bottom: 20px; }
