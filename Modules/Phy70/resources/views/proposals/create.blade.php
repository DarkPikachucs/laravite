      ...
      <form action="{{ $route }}" method="POST" id="proposal-form" enctype="multipart/form-data"
        ...
        <div class="form-section">
          ...
          <div class="form-group" x-show="formData.province_issue">
            <label class="form-label">แผนงานหลัก <span style="color: var(--danger);">*</span></label>
            <select name="main_plan" class="form-control" :value="formData.main_plan"
              @change="formData.main_plan = $event.target.value" :required="!!formData.province_issue">
              <option value="">-- เลือกแผนงานหลัก --</option>
              <template x-if="currentMainPlans">
                <template x-for="(mp, mpIndex) in currentMainPlans" :key="'mp'+mpIndex">
                  <option :value="mp" x-text="mp" :selected="mp === formData.main_plan"></option>
                </template>
              </template>
            </select>
          </div>
  ...
  <script>
    document.addEventListener('alpine:init', () => {
        const issuesData = [
            {
                ...
                "main_plan": "การพัฒนาการท่องเที่ยวคุณภาพมูลค่าสูง ด้วยการยกระดับผลิตภัณฑ์และบริการบนฐานอัตลักษณ์ของท้องถิ่น และการส่งเสริมการท่องเที่ยวด้านสุขภาพและประสบการณ์สร้างสรรค์มูลค่าสูง",
                "subplans": [
                    "พัฒนาโครงสร้างพื้นฐาน สิ่งอำนวยความสะดวก และสร้างระบบนิเวศสนับสนุนการท่องเที่ยว",//"พัฒนาโครงสร้างพื้นฐาน สิ่งอำนวยความสะดวก และสร้างระบบนิเวศสนับสนุนการท่องเที่ยว",
                    "ยกระดับผลิตภาพแรงงานและศักยภาพผู้ประกอบการภาคบริการการท่องเที่ยว เพื่อรองรับนักท่องเที่ยวคุณภาพและนักท่องเที่ยวมูลค่าสูง",//"พัฒนาแหล่งท่องเที่ยวและเส้นทางท่องเที่ยวมูลค่าสูง",
                    "พัฒนาผลิตภัณฑ์และบริการการท่องเที่ยวมูลค่าสูงบนฐานอัตลักษณ์ท้องถิ่น พร้อมเชื่อมโยงเครือข่ายการท่องเที่ยวโดยชุมชน",//"ยกระดับผลิตภาพแรงงานภาคบริการ",
                    "ส่งเสริมการประชาสัมพันธ์ การตลาด และการเข้าถึงตลาดการท่องเที่ยว ด้วยเทคโนโลยีดิจิทัล",//"สร้างมูลค่าเพิ่มให้กับสินค้าและบริการการท่องเที่ยวมูลค่าสูง",
            ...
            },
            {
                ...
                "main_plan": "การยกระดับสินค้าเกษตรจังหวัดเพชรบูรณ์ สู่เกษตรมูลค่าสูงบนฐานนวัตกรรมสีเขียว และการยกระดับผลิตภาพแรงงานเพื่อลดความเหลื่อมลํ้าและเสริมสร้างความเข้มแข็งของเศรษฐกิจฐานราก",
                "subplans": [
                    "พัฒนาโครงสร้างพื้นฐานและปัจจัยพื้นฐานการส่งเสริมเกษตรมูลค่าสูง",  //"พัฒนาโครงสร้างและปัจจัยพื้นฐานการส่งเสริมเกษตรมูลค่าสูง",
                    "ยกระดับผลิตภาพแรงงานในภาคการเกษตรสู่การผลิตสินค้าเกษตรมูลค่าสูง",//"ยกระดับผลิตภาพแรงงานในภาคการเกษตร",
                    "ยกระดับประสิทธิภาพการผลิตและมาตรฐานคุณภาพสินค้าเกษตรตลอดห่วงโซ่มูลค่าสู่มาตรฐานสากล",//"ยกระดับมาตรฐานและคุณภาพสินค้าสู่มาตรฐานสากล",
                    "ส่งเสริมการวิจัย พัฒนา และประยุกต์ใช้เทคโนโลยีและนวัตกรรม เพื่อยกระดับคุณภาพ และสร้างมูลค่าเพิ่มให้แก่สินค้าเกษตรมูลค่าสูง",//"เชื่อมโยงสินค้าเกษตร สู่การท่องเที่ยวและภาคบริการอื่น",
                    "ส่งเสริมการตลาด การสร้างอัตลักษณ์ และขยายช่องทางการจำหน่ายสินค้าเกษตร",//"ส่งเสริมการวิจัย พัฒนา และนำงานวิจัย เทคโนโลยี และนวัตกรรมเพื่อยกระดับสินค้าเกษตรมูลค่าสูง",
                    "ส่งเสริมและบูรณาการโครงการอันเนื่องมาจากพระราชดำริเพื่อการพัฒนาที่ยั่งยืน",//"เพิ่มประสิทธิภาพการผลิตภาคเกษตรตลอดห่วงโซ่มูลค่า (การผลิต การแปรรูป การจัดจำหน่าย)"
                ],
                "guidelines": [
                    ...
                    "การยกระดับการเกษตรมูลค่าสูง บนฐานโครงการอันเนื่องมาจากพระราชดําริและการอนุรักษ์พันธุกรรมพืช"
                ]
            },
            {
                ...
                "main_plan": "การพัฒนาความมั่นคง ยกระดับคุณภาพชีวิต บริการสาธารณะอย่างทั่วถึง และพัฒนาสภาพแวดล้อมที่เอื้อต่อการดำรงชีวิตของคนทุกช่วงวัย",
                "subplans": [
                    "พัฒนาและยกระดับโครงสร้างพื้นฐานและบริการสาธารณะ เพื่อส่งเสริมคุณภาพชีวิตของประชาชน",//"พัฒนาโครงสร้างพื้นฐานเพื่อสนับสนุนการพัฒนาคุณภาพชีวิต (การศึกษา/ สาธารณสุข/สังคม / ความมั่นคง)",
                    "การเพิ่มผลิตภาพแรงงาน การพัฒนาทุนมนุษย์ และส่งเสริมการมีงานทำและการสร้างรายได้ให้สอดคล้องกับศักยภาพของพื้นที่", //"การเพิ่มผลิตภาพแรงงาน และการพัฒนาทุนมนุษย์",
                    "พัฒนาระบบสวัสดิการ ระบบบริการสุขภาพ และสภาพแวดล้อมที่เอื้อต่อการดำรงชีวิตของประชาชนทุกช่วงวัย",//"พัฒนาระบบสวัสดิการ บริการสาธารณะ และสภาพแวดล้อมที่เอื้อต่อคนทุกช่วงวัย",
                    "ส่งเสริมศักยภาพผู้สูงอายุ เสริมสร้างทุนทางสังคม และพัฒนากระบวนการมีส่วนร่วมและความเป็นหุ้นส่วนในการพัฒนาสังคม",
                    //"พัฒนาสภาพแวดล้อมที่เอื้อต่อคนทุกช่วงวัยเพื่อการเรียนรู้ตลอดชีวิต",//"พัฒนาระบบบริการสุขภาพ ระบบสาธารณสุข และการใช้เทคโนโลยีในการขยายการเข้าถึงบริการ",
                    //"ส่งเสริมผู้สูงอายุให้มีศักยภาพและมีส่วนร่วมในสังคม",
                    //"ส่งเสริมกระบวนการทางสังคม พัฒนาทุนทางสังคม สร้างการมีส่วนร่วมการเป็นหุ้นส่วนในการพัฒนาสังคมทุกมิติ",
                ...
                "guidelines": [
                    ...
                    "พัฒนาสภาพแวดล้อมที่เอื้อต่อคนทุกช่วงวัยเพื่อการเรียนรู้ตลอดชีวิต",
                    "ส่งเสริมผู้สูงอายุให้มีศักยภาพและมีส่วนร่วมในสังคม",
            ...
            },
            {
                ...
                "kpis": [
                  {"name": "ผลิตภัณฑ์มวลรวมจังหวัด (GPP) เพิ่มขึ้น", "base_year": 2567, "base_value": "95,455 ล้านบาท", "target_unit": "ร้อยละ", "targets": [5, 5, 5, 5, 5]},
                  {"name": "ผลิตภัณฑ์มวลรวมจังหวัด (GPP) ภาคอุตสาหกรรมเพิ่มขึ้น", "base_year": 2567, "base_value": ".......ล้านบาท", "target_unit": "ร้อยละ", "targets": [3, 3, 3, 3, 3]},
                  {"name": "จำนวนวิสาหกิจขนาดกลางและขนาดย่อมเพิ่มขึ้น", "base_year": 2568, "base_value": "23 แห่ง", "target_unit": "ร้อยละ", "targets": [3, 3, 3, 3, 3]}
                ],
                "main_plan": "การพัฒนาอุตสาหกรรมนวัตกรรมฐานชีวภาพและดิจิทัลสีเขียว และการส่งเสริมการเจริญเติบโตทางเศรษฐกิจที่ยั่งยืน",
                "subplans": [
                    "พัฒนาโครงสร้างพื้นฐานและระบบโลจิสติกส์เพื่อสนับสนุนการเจริญเติบโตทางเศรษฐกิจ",
                    "ยกระดับผลิตภาพแรงงานและศักยภาพผู้ประกอบการ วิสาหกิจขนาดกลางและขนาดย่อม ตลอดจนเครือข่ายอุตสาหกรรม ให้สอดคล้องกับศักยภาพของพื้นที่และสามารถเชื่อมโยงสู่ตลาดมูลค่าสูง", //"ต่อยอดทรัพยากรและพืชอัตลักษณ์ของจังหวัดสู่การผลิตสินค้ามูลค่าสูง",
                    "ต่อยอดทรัพยากรชีวภาพและพืชอัตลักษณ์ของจังหวัด ด้วยการวิจัย เทคโนโลยี และนวัตกรรม เพื่อพัฒนาผลิตภัณฑ์และอุตสาหกรรมมูลค่าสูง", //"ส่งเสริมการวิจัยและพัฒนาองค์ความรู้ นวัตกรรม และความร่วมมือกับภาคเอกชน เพื่อสนับสนุนการพัฒนาผลิตภัณฑ์และอุตสาหกรรมในพื้นที่",
            ...
            },
            {
                ...
                "kpis": [
                  ...
                  {"name": "ร้อยละประชากรที่ประสบภัยพิบัติทางธรรมชาติ", "base_year": 2568, "base_value": "9.42", "target_unit": "ร้อยละ", "targets": [5, 5, 5, 5, 5]},
                  {"name": "จำนวนสถานประกอบการที่ผ่านเกณฑ์อุตสาหกรรมสีเขียว ระดับที่ 2 เพิ่มขึ้น", "base_year": 2568, "base_value": "23 แห่ง", "target_unit": "ร้อยละ", "targets": [3, 3, 3, 3, 3]},
                  //{"name": "จำนวนจุดความร้อน Hotspot ลดลง", "base_year": null, "base_value": "0 แห่ง", "target_unit": "ร้อยละ", "targets": [10, 10, 10, 10, 10]},
                  {"name": "จำนวนวันที่ปริมาณฝุ่นละอองขนาดเล็ก (PM2.5) อยู่ในเกณฑ์มาตรฐาน", "base_year": null, "base_value": "0 แห่ง", "target_unit": "ร้อยละ", "targets": [10, 10, 10, 10, 10]},
                  {"name": "ปริมาณการปล่อยก๊าซเรือนกระจกลดลง", "base_year": 2562, "base_value": "0.4770", "target_unit": "tCO2/MWh", "targets": [5, 5, 5, 5, 5]},
                ],
                "main_plan": "การจัดการทรัพยากรธรรมชาติและสิ่งแวดล้อม และลดความเสี่ยงจากภัยพิบัติที่สำคัญของพื้นที่",
                "subplans": [
                    "พัฒนาโครงสร้างพื้นฐานสีเขียว เพื่อส่งเสริมระบบนิเวศเมืองอัจฉริยะและการบริหารจัดการทรัพยากรธรรมชาติและสิ่งแวดล้อม",//"พัฒนาโครงสร้างพื้นฐานสีเขียว ระบบนิเวศเมืองอัจฉริยะ และระบบการบริหารจัดการทรัพยากรธรรมชาติ",
                    "เสริมสร้างขีดความสามารถในการปรับตัวและรับมือกับผลกระทบจากการเปลี่ยนแปลงสภาพภูมิอากาศและภัยพิบัติ",//"การเสริมสร้างขีดความสามารถในการปรับตัวและรับมือกับผลกระทบจากการเปลี่ยนแปลงสภาพภูมิอากาศ",
                    "อนุรักษ์ ฟื้นฟู และบริหารจัดการทรัพยากรป่าต้นน้ำและทรัพยากรธรรมชาติที่สำคัญ", //"เปลี่ยนผ่านภาคการผลิตที่เป็นมิตรต่อสิ่งแวดล้อม",
                    "ประยุกต์ใช้ข้อมูลเชิงพื้นที่และเทคโนโลยีในการวางแผนการบริหารจัดการทรัพยากรธรรมชาติและสิ่งแวดล้อม", //"การฟื้นฟูป่าต้นน้ำ และทรัพยากรทางธรรมชาติที่สำคัญ",
                    "ส่งเสริมการปรับเปลี่ยนภาคการผลิตสู่กระบวนการผลิตที่เป็นมิตรต่อสิ่งแวดล้อม และการใช้ทรัพยากรอย่างมีประสิทธิภาพ", //"ใช้ข้อมูลเชิงพื้นที่และเทคโนโลยีในการวางแผนการบริหารจัดการทรัพยากรธรรมชาติและสิ่งแวดล้อม",
        ...
        Alpine.data('proposalForm', () => ({
            ...
            onIssueChange() {
                this.loadKPIs();
                // รีเซ็ตแผนงานหลักเมื่อเปลี่ยนประเด็น
                const mains = this.currentMainPlans;
                if (!mains.includes(this.formData.main_plan)) {
                    this.formData.main_plan = mains.length === 1 ? mains[0] : '';
                }
