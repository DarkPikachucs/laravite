        ...
        <div class="form-section">
          ...
          <div class="form-group" x-show="formData.province_issue">
            ...
            <select name="plan" class="form-control" :value="formData.plan"
              ...
              <template x-if="formData.province_issue && subplansData[formData.province_issue]">
                <template x-for="(sp, spIndex) in subplansData[formData.province_issue]" :key="spIndex">
    ...
    document.addEventListener('alpine:init', () => {
        const issuesData = [
            {
                ...
                "kpis": [
                  ...
                  {"name": "จำนวนของสถานประกอบการด้านการท่องเที่ยว ได้รับมาตรฐานเพิ่มขึ้น", "base_year": 2568, "base_value": null, "target_unit": "ร้อยละ", "targets": [10,10,10,10,10]}
                ]
            },
            {
            ...
            },
            {
                ...
                "kpis": [
                  ...
                  {"name": "จำนวนผู้ประกอบการหรือวิสาหกิจเพิ่มขึ้น", "base_year": null, "base_value": "-", "target_unit": "ร้อยละ", "targets": ["","","","",""]}
                ]
            },
            {
                "issue": "ประเด็นการพัฒนาที่ 5 การบริหารจัดการทรัพยากรธรรมชาติและสิ่งแวดล้อมเพื่อความสมดุล",
                "kpis": [
                  {"name": "สัดส่วนปริมาณขยะที่กำจัดได้อย่างถูกต้อง ต่อปริมาณขยะที่เกิดขึ้นเพิ่มขึ้น", "base_year": 2568, "base_value": "19.53", "target_unit": "ร้อยละ", "targets": [5,5,5,5,5]},
                  ...
                  {"name": "จำนวนจุดความร้อน Hotspot ลดลง", "base_year": null, "base_value": "-", "target_unit": "ร้อยละ", "targets": ["","","","",""]},
                  {"name": "ลดก๊าซเรือนกระจก ร้อยละ 5 จากปีฐาน (2562)", "base_year": null, "base_value": "-", "target_unit": "ร้อยละ", "targets": ["","","","",""]}
                ]
            }
        ];
        ...
        const guidelinesData = {
            "ประเด็นการพัฒนาที่ 1 การพัฒนาการท่องเที่ยวมูลค่าสูงเชิงสร้างสรรค์บนฐานอัตลักษณ์ของพื้นที่": [
                ...
                "พัฒนาการท่องเที่ยวให้เป็นจุดหมายปลายทางการท่องเที่ยวเชิงสุขภาพและประสบการณ์มูลค่าสูง",
            ...
            "ประเด็นการพัฒนาที่ 2 การพัฒนาการเกษตรมูลค่าสูงอย่างยั่งยืน": [
                ...
                "ยกระดับผลิตภาพและเพิ่มประสิทธิภาพการผลิตภาคเกษตร การเพิ่มโอกาสเข้าสู่ตลาดมูลค่าสูงและตลาดระดับพรีเมียม",
            ...
            "ประเด็นการพัฒนาที่ 3 การพัฒนาความมั่นคง คุณภาพชีวิต การศึกษา และผลิตภาพคนทุกช่วงวัย": [
                ...
                "การเพิ่มผลิตภาพแรงงานในทุกสาขา และการยกระดับทุนมนุษย์ทุกช่วงวัย",
                ...
                "การบริหารจัดการกำลังคนด้านสาธารณสุขเพื่อรองรับระบบบริการที่มีคุณภาพ",
            ...
            "ประเด็นการพัฒนาที่ 4 การส่งเสริมการเจริญเติบโตทางเศรษฐกิจที่ยั่งยืน": [
                ...
                "เชื่อมโยงภาคการเกษตร บริการสุขภาพ และอุตสาหกรรม ต่อยอดทรัพยากรและพืชอัตลักษณ์ของพื้นที่สู่การผลิตสินค้ามูลค่าสูงให้อยู่ในห่วงโซ่มูลค่า เพื่อสร้างผลกระทบทางเศรษฐกิจให้กับจังหวัด",
                "ส่งเสริมการวิจัยและพัฒนาเพื่อสร้างองค์ความรู้และนวัตกรรม ที่สอดคล้องกับอุตสาหกรรมในพื้นที่",
                "ส่งเสริมความร่วมมือกับภาคเอกชนเพื่อสนับสนุนการพัฒนาผลิตภัณฑ์มูลค่าสูง",
                "ส่งเสริมการผลิตที่เป็นมิตรต่อสิ่งแวดล้อม ตามแนวคิดเศรษฐกิจหมุนเวียน",
                "พัฒนาโครงข่ายการขนส่งเพื่อสนับสนุนกิจกรรมทางเศรษฐกิจในภูมิภาค",
            ...
            "ประเด็นการพัฒนาที่ 5 การบริหารจัดการทรัพยากรธรรมชาติและสิ่งแวดล้อมเพื่อความสมดุล": [
                "พัฒนาโครงสร้างพื้นฐาน การพัฒนาระบบนิเวศเมืองอัจฉริยะ และระบบการบริหารจัดการทรัพยากรธรรมชาติอย่างเป็นระบบ",
                ...
                "ส่งเสริมกลไกการตั้งรับปรับตัวภาคประชาชนให้พร้อมรองรับปัญหาด้านสิ่งแวดล้อม",
        ...
        Alpine.data('proposalForm', () => ({
            ...
            onIssueChange() {
                ...
                const subs = this.subplansData[this.formData.province_issue] || [];
                if (!subs.includes(this.formData.plan)) {
                    this.formData.plan = '';
                }
                // รีเซ็ตแนวทางของกิจกรรมที่ไม่อยู่ในประเด็นใหม่
                const guides = this.guidelinesData[this.formData.province_issue] || [];
                this.formData.activities.forEach(act => {
