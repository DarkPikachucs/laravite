            ...
            <ul className="flex flex-col list-none lg:flex-row lg:ml-auto">
              ...
              <li className="flex items-center">
                <button
                  ...
                  className="px-4 py-2 mb-3 ml-3 text-xs font-bold uppercase transition-all duration-150 ease-linear bg-red-500 rounded shadow outline-none text-white active:bg-red-600 hover:shadow-md focus:outline-none lg:mr-1 lg:mb-0 hover:bg-red-600"
                  type="button"
                >
